...
<form action="{{ $route }}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="quantity" id="quantity" class="form-control" value="{{ old('quantity',$products->quantity) }}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" step='0.5' name="price" id="price" class="form-control" value="{{ old('price',$products->price) }}">
    </div>
    ...
    <div class="form-group">
        ...
        <select  name="category_id" id="category_id" class="form-select"> 
            ...
            @foreach ($categories as $category )
                 <option @selected(old('category_id',$products->category_id === $category->id)) value="{{ $category->id }}">{{ $category->name }}</option>
            @endforeach
