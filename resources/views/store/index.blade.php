...
<form method="get">
    <div class="form-group">
        ...
        @foreach($categories as $category)
         <div class="form-check">
            <input @checked(in_array($category->id,$categoriesId)) id="{{ $category->id }}" type="checkbox" name ="categories[]" value="{{ $category->id }}" class="form-check-input">
  ...
  <option  selected>Open this select menu</option>
   @foreach($categories as $category)
      <option @selected(in_array($category->id,$categoriesSelect)) id="{{ $category->id }}"  value="{{ $category->id}}">{{ $category->name}}</option>
    @endforeach
</select>
        ...
        <div class="form-group">
            ...
            <input min="" max="" type="number" name="min" id="min" value="" class="form-control"
                   placeholder="Min price">
            <label for="max">Max</label>
            <input min="" max="" type="number" name="max" id="max" value="" class="form-control"
